...
<body>
        ...
        <div class="modal-box">
            ...
            <div class="fg2">
                <div class="fg full">
                    ...
                    <input type="text" id="t-nama" class="fi" placeholder="Cth: PT. Kimia Farma">
                </div>
                <div class="fg full">
                    <label>Alamat</label>
                    <input type="text" id="t-alamat" class="fi" placeholder="Jl. Contoh No. 1, Kota">
                </div>
                <div class="fg">
                    <label>No. Telepon</label>
                    <input type="text" id="t-telp" class="fi" placeholder="021-xxxxxxx">
                </div>
                <div class="fg">
                    <label>Email</label>
                    <input type="email" id="t-email" class="fi" placeholder="email@domain.com">
                </div>
                <div class="fg full">
                    <label>Status</label>
    ...
    <script>
        ...
        function submitTambah() {
            ...
            fd.append('no_telp', document.getElementById('t-telp').value);
            fd.append('email', document.getElementById('t-email').value);
        ...
        function appendRow(d) {
            ...
            tr.innerHTML = `
        <td><span class="id-mono">${idDisplay}</span></td>
        <td><div class="sup-info"><div class="sup-avatar">${initials}</div><span class="td-name">${d.nama}</span></div></td>
